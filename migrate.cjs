...
DROP TABLE IF EXISTS costs_details CASCADE;
DROP TABLE IF EXISTS invoice_headers CASCADE;
DROP TABLE IF EXISTS costs_header CASCADE;
...
async function main() {
  ...
  try {
    ...
    console.log('Schema recreated successfully with quoted camelCase columns.');
  } catch (e) {
